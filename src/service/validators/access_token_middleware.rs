...
use super::jwt::DecodeAccessToken;
    ...
    B: 'static,
{
    ...
    type Error = Error;
    type Transform = AccessTokenMiddlewareInner<S>;
    type InitError = ();
    type Future = Ready<Result<Self::Transform, Self::InitError>>;

    fn new_transform(&self, service: S) -> Self::Future {
        Ok(AccessTokenMiddlewareInner {
...
pub struct AccessTokenMiddlewareInner<S> {
    service: Rc<S>,
    state: web::Data<AppState<'static>>,
}

impl<S, B> Service<ServiceRequest> for AccessTokenMiddlewareInner<S>
where
    S: Service<ServiceRequest, Response = ServiceResponse<B>, Error = Error> + 'static,
    S::Future: 'static,
    B: 'static,
